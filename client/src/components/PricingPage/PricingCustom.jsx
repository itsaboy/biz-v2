...
export default function PricingCustom() {
  return (
    <div className="bg-slate-950 flex flex-col items-start gap-x-8 gap-y-6 rounded-3xl mt-8 p-8 sm:gap-y-10 sm:p-10 lg:col-span-2 lg:flex-row lg:items-center shadow-lg shadow-indigo-400/40 ring-2 ring-slate-800">
